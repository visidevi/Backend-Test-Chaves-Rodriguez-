...
APP_TZ = getenv("APP_TZ", default="America/Santiago")
JWT_AUTH = {"JWT_EXPIRATION_DELTA": datetime.timedelta(days=3)}
FIXTURE_DIRS = (os.path.join(BASE_DIR, "fixtures/"),)
MAX_ORDER_HOUR = getenv("MAX_ORDER_HOUR", default="11")
NOTIFICATION_HOUR = getenv("NOTIFICATION_HOUR", default="10")
SLACK_APP_TOKEN = getenv(
